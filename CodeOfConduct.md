...
3. Intentionally making false accusations, with the intent to have that player removed from the game/lobby, is abusive. We understand that mistakes happen, and no one knows everything that goes on in each match they play.
